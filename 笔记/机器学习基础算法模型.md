...
![](../../../%E7%BA%BF%E6%80%A7%E4%BB%A3%E6%95%B0/LinearAlgera/images/Snipaste_2020-11-13_17-00-13.png)
...
####2.2.5 最好的衡量线性回归算法的指标：R Squared
...
==使用梯度下降法之前最好进行数据的归一化，而使用正规化方程解则不需要进行数据的归一化，因为正规化方程给出的是一个计算公式，牵扯到的搜索过程比较少，而使用梯度下降法求解的时候涉及到的搜索过程比较多,对数据进行归一化可以提高搜索效率（为什么要对数据进行归一化:<https://blog.csdn.net/feijie7788/article/details/89812737>）：不对数据归一化，得到的等值特征线可能会变得非常尖，==
...
![image-20201218160430278](../../../%E7%BA%BF%E6%80%A7%E4%BB%A3%E6%95%B0/LinearAlgera/images/image-20201218160430278.png)
...
![image-20201221162321696](../../../%E7%BA%BF%E6%80%A7%E4%BB%A3%E6%95%B0/LinearAlgera/images/image-20201221162321696.png)
...
![image-20201221175738955](../../../%E7%BA%BF%E6%80%A7%E4%BB%A3%E6%95%B0/LinearAlgera/images/image-20201221175738955.png)
...
### 6.10 OVR与OVO(通用的解决二分类算法在多分类问题上也能起作用的方法)

![image-20201221171757757](../../../%E7%BA%BF%E6%80%A7%E4%BB%A3%E6%95%B0/LinearAlgera/images/image-20201221171757757.png)

![image-20201221171837664](../../../%E7%BA%BF%E6%80%A7%E4%BB%A3%E6%95%B0/LinearAlgera/images/image-20201221171837664.png)
...
==精准率是指假如我们做了100次分类为1的预测，其中预测正确的比例：拿预测肿瘤为例：在所有我们预测有恶性肿瘤的病人中，实际上有恶性肿瘤的百分比，当然我们希望我们预测的越正确越好，即我们希望我们的模型精准率越高越好==

==召回率是指实际上有100个我们关注的事件发生，其中我们预测也是发生的次数：同样拿预测肿瘤为例：在所有实际上有恶性肿瘤的病人中，成功预测有恶性肿瘤的病人的百分比，同样我们希望我们的预测越正确越好，即我们希望我们的模型召回率越高越好====

### 7.4 精准率和召回率在极度偏差的数据中的作用
...
#### 7.4.1 scikit-learn中的混淆矩阵、精确率、召回率
...
from sklearn.metrics import precision_score
from sklearn.metrics import recall_score
#decision_scores是θ的转置*Xb的结果
decision_scores = log_reg.decision_function(X_test)
#默认是以0作为阈值的，即>0分类为1，<0分类为0，我们可以通过改变阈值，来绘制精准率和召回率曲线
...
#### 7.6.2 scikit-learn中的precision-recall曲线
...
#### 7.7.2 ROC曲线面积越大，该模型越好

同一fpr下，tpr越大,相对应的模型越好
...
![image-20201225091220516](../../../%E7%BA%BF%E6%80%A7%E4%BB%A3%E6%95%B0/LinearAlgera/images/image-20201225091220516.png)

![image-20201225102333196](../../../%E7%BA%BF%E6%80%A7%E4%BB%A3%E6%95%B0/LinearAlgera/images/image-20201225102333196.png)

![image-20201225094703107](../../../%E7%BA%BF%E6%80%A7%E4%BB%A3%E6%95%B0/LinearAlgera/images/image-20201225094703107.png)
...
![image-20201225142451430](../../../%E7%BA%BF%E6%80%A7%E4%BB%A3%E6%95%B0/LinearAlgera/images/image-20201225142451430.png)

![image-20201225142724077](../../../%E7%BA%BF%E6%80%A7%E4%BB%A3%E6%95%B0/LinearAlgera/images/image-20201225142724077.png)

![image-20201225143101576](../../../%E7%BA%BF%E6%80%A7%E4%BB%A3%E6%95%B0/LinearAlgera/images/image-20201225143101576.png)

![image-20201225151437105](../../../%E7%BA%BF%E6%80%A7%E4%BB%A3%E6%95%B0/LinearAlgera/images/image-20201225151437105.png)

![image-20201225153031068](../../../%E7%BA%BF%E6%80%A7%E4%BB%A3%E6%95%B0/LinearAlgera/images/image-20201225153031068.png)

![image-20201225154050722](../../../%E7%BA%BF%E6%80%A7%E4%BB%A3%E6%95%B0/LinearAlgera/images/image-20201225154050722.png)

![image-20201225155200794](../../../%E7%BA%BF%E6%80%A7%E4%BB%A3%E6%95%B0/LinearAlgera/images/image-20201225155200794.png)

![image-20201225155649871](../../../%E7%BA%BF%E6%80%A7%E4%BB%A3%E6%95%B0/LinearAlgera/images/image-20201225155649871.png)

![image-20201225160456141](../../../%E7%BA%BF%E6%80%A7%E4%BB%A3%E6%95%B0/LinearAlgera/images/image-20201225160456141.png)

![image-20201225161436908](../../../%E7%BA%BF%E6%80%A7%E4%BB%A3%E6%95%B0/LinearAlgera/images/image-20201225161436908.png)
